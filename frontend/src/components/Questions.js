        ...
        <ul className="navbar-nav mr-auto">
         ...
         <div >
            <div className='container ' >
                <div className='container' style={{backgroundColor:"#fff2f1",marginTop:"100px",width:"60cm"}}>
                    <div className='tushar px-2 py-2' >
                        <div className='mx-2 my-2' style={{width:"20cm"}}>
                        <p>
                            <a
                                className="btn btn-danger col-sm-2 col-lg-2"
                                        ...
                                        <div className="form-group">
                                            <div className="form-row my-3">
                                                <div className="col-md-3 mb-3">
                                                    <label htmlFor="appt"><h3>Questions </h3></label>
                                                </div>
                                                <div className="col-md-3 mb-3">
                                                ...
                                                <div className="col-md-2 mb-3\2">
                                                <label htmlFor="appt" style={{display:"inline"}}>Correct Option </label>
                                                    <select value={formData.correctoption} onChange={handleChange} name="correctoption" className="custom-select custom-select-sm" >
                                                        <option value="DEFAULT"disabled>Correct Option</option>
