...
const Exampage = (props) => {
  ...
  const changeques = (e) => {
    ...
    if (radio != null) {
      ...
      try {
        document.getElementById(`lowerques${quesno.current}`).className =
          "attempted";
      } catch (error) {
        console.log(error);
      }
      ...
      {load && element !== null && (
        <div className="abcd7">
          <div id="redtime" className="uppertime">
            <p className="topleft">Question No : {quesno.current} </p>
            <p className="topright">
              Time Left : <span id="timeremain"></span>{" "}
            </p>
          </div>
            ...
            <div className="maindiv">
              <div className="upperdiv">
                <div className="upperques">
                  <p className="topques">{element.ques}</p>
                </div>
                <div className="chcg">
