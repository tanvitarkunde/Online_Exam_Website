...
const ExamDetails = (props) => {
    ...
    return (
        <div className="row my-3">
            ...
            <div className="col-sm-2">
                <Link to="/editexampage" state={props.element}  id='yesorno'  aria-pressed="true">Edit Exam</Link>

            </div>
            <div className="col-sm-2">
                <button type="submit" onClick={handleSubmit} className="btn btn-danger" style={{width:"10rem"}}>Apply changes</button>
            </div>
